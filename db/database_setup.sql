...
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('nginx-proxy-a-host-1', 2, '192.168.8.0', false, 'nginx-proxy-a', 'TAIPEI-A1', 'TPE1-ROOM-103', 'TPE1-R103-RACK-4', 1) ON CONFLICT DO NOTHING;
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('nginx-proxy-a-host-2', 3, '192.168.8.1', false, 'nginx-proxy-a', 'TAIPEI-A1', 'TPE1-ROOM-103', 'TPE1-R103-RACK-4', 3) ON CONFLICT DO NOTHING;
...
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('auth-service-b-host-1', 1, '192.168.199.0', false, 'auth-service-b', 'TAIPEI-A1', 'TPE1-ROOM-101', 'TPE1-R101-RACK-1', 1) ON CONFLICT DO NOTHING;
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('auth-service-b-host-2', 2, '192.168.199.1', false, 'auth-service-b', 'TAIPEI-A1', 'TPE1-ROOM-101', 'TPE1-R101-RACK-1', 2) ON CONFLICT DO NOTHING;
...
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('auth-service-b-host-4', 1, '192.168.199.3', false, 'auth-service-b', 'TAIPEI-A1', 'TPE1-ROOM-101', 'TPE1-R101-RACK-1', 6) ON CONFLICT DO NOTHING;
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('auth-service-b-host-5', 4, '192.168.199.4', false, 'auth-service-b', 'TAIPEI-A1', 'TPE1-ROOM-103', 'TPE1-R103-RACK-1', 1) ON CONFLICT DO NOTHING;
...
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('palworld-server-a-host-1', 1, '192.168.10.0', false, 'palworld-server-a', 'TAIPEI-C2', 'TPE2-ROOM-102', 'TPE2-R102-RACK-2', 1) ON CONFLICT DO NOTHING;
...
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('palworld-server-a-host-4', 4, '192.168.10.3', false, 'palworld-server-a', 'TAIPEI-C2', 'TPE2-ROOM-102', 'TPE2-R102-RACK-4', 3) ON CONFLICT DO NOTHING;
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('palworld-server-a-host-5', 1, '192.168.11.0', false, 'palworld-server-a', 'TAIPEI-C2', 'TPE2-ROOM-102', 'TPE2-R102-RACK-4', 7) ON CONFLICT DO NOTHING;
...
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('palworld-server-a-host-7', 3, '192.168.11.2', false, 'palworld-server-a', 'TOKYO-A1', 'TYO1-ROOM-104', 'TYO1-R104-RACK-1', 1) ON CONFLICT DO NOTHING;
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('palworld-server-a-host-8', 4, '192.168.11.3', false, 'palworld-server-a', 'TOKYO-A1', 'TYO1-ROOM-104', 'TYO1-R104-RACK-1', 4) ON CONFLICT DO NOTHING;
...
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('web-hosting-service-host-3', 3, '192.168.100.130', false, 'web-hosting-service', 'TAIPEI-A1', 'TPE1-ROOM-102', 'TPE1-R102-RACK-3', 3) ON CONFLICT DO NOTHING;
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('web-hosting-service-host-4', 4, '192.168.100.131', false, 'web-hosting-service', 'TAIPEI-A1', 'TPE1-ROOM-102', 'TPE1-R102-RACK-3', 6) ON CONFLICT DO NOTHING;
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('web-hosting-service-host-5', 1, '192.168.100.132', false, 'web-hosting-service', 'TAIPEI-A1', 'TPE1-ROOM-102', 'TPE1-R102-RACK-3', 10) ON CONFLICT DO NOTHING;
...
INSERT INTO hosts (name, height, ip, running, service_name, dc_name, room_name, rack_name, pos) VALUES ('web-hosting-service-host-7', 2, '192.168.100.134', false, 'web-hosting-service', 'TAIPEI-C2', 'TPE2-ROOM-101', 'TPE2-R101-RACK-2', 2) ON CONFLICT DO NOTHING;
